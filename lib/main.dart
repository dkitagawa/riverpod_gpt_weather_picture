...
class InputRow extends ConsumerWidget {
  ...
  void loadWeatherImage(String area, String date, WidgetRef ref)  {
    var prompt = "天気を、対象地域のシンボリックな建物と名産品や名物を主役にして、人間もすこし盛り込んで表現してください。イメージは空撮からの視点ではなく、地上からの視点で表現してください。指定された地域名、日付、最高気温、最低気温、降水確率を個別に取得し、地域名を1番、日付を2番目に大きく表示してください。日付はMM/dd形式に変換して表示してください。最高／最低気温と降水確率は一箇所にコンパクトにまとめて表記してください。また、何らかのマンガもしくは有名な音楽CDやレコードのジャケットをオマージュしてください。";
